 ...
 */
export const API_SERVICE_VERSION = "1.0.0" as const;
export const API_CATALOG_VERSION = "1.0.0" as const;
/** Phiên bản tài liệu ràng buộc tích hợp Agent Gateway */
export const API_CONSTRAINTS_DOC_VERSION = "1.0.0" as const;

/** Số operation trong agent-gateway-api-catalog.json (kiểm tra khi đổi catalog) */
export const API_CATALOG_OPERATIONS_COUNT = 26 as const;
